...
export default function Form({ addItems }) {
    ...
    return(
      <form className="add-form" onSubmit={handleSubmit}>
        {/* Two different ways to prevent the page from default reload on submit. 
          1) - By handling event on a funtion as it is shown above or in line.
          2) - In line - Ex: <form className="add-form" onSubmit={(e)=> handleSubmit(e)}
        */}
